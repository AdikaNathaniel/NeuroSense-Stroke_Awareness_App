...
cells.push(md('## 3. Quick inspection'));
cells.push(code('df.info()'));
cells.push(code("df.describe(include='all').T"));
cells.push(code(
...
cells.push(md('## 6. Train/test split',
  '',
...
cells.push(md('## 7. Preprocessing pipeline',
  '',
...
cells.push(md('## 8. Evaluation helper',
  '',
...
cells.push(md('## 9. Imbalance strategy A — class weighting',
  '',
...
cells.push(md('## 10. Imbalance strategy B — `scale_pos_weight` (XGBoost)'));
cells.push(code(
...
cells.push(md('## 11. Imbalance strategy C — SMOTE oversampling',
  '',
...
cells.push(md('## 12. Cross-validated PR-AUC for the leaders',
  '',
...
cells.push(md('## 13. Model comparison'));
cells.push(code(
...
cells.push(md('## 14. Threshold tuning',
  '',
...
cells.push(md('## 15. Feature importance',
  '',
...
cells.push(md('## 16. Save the model',
  '',
...
cells.push(md('## 17. Inference example'));
cells.push(code(
...
const out = path.join(__dirname, 'neurosense_stroke_prediction.ipynb');
